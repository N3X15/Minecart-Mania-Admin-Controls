...
public class AdminControlsSettingParser implements SettingParser {
            ...
            for (int idx = 0; idx < list.getLength(); idx++) {
                ...
                if (elementChild.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if ((elementChildValue != null) && (elementChildValue != "")) {
                        ...
                        } else if ((elementChildName == "EmptyMinecartKillTimer") || (elementChildName == "EmptyStorageMinecartKillTimer") || (elementChildName == "EmptyPoweredMinecartKillTimer")) {
    ...
    private int getDefaultConfigurationIntegerValue(final String ConfigName) {
        if (ConfigName == "EmptyMinecartKillTimer")
            return (-1);
        if (ConfigName == "EmptyStorageMinecartKillTimer")
            return (-1);
        if (ConfigName == "EmptyPoweredMinecartKillTimer")
            return (-1);
        return 0;
    }
    ...
    private void debugShowConfigs() {
        ...
        for (final Enumeration<String> ConfigKeys = MinecartManiaWorld.getConfiguration().keys(); ConfigKeys.hasMoreElements();) {
            ...
            if ((temp == "EmptyMinecartKillTimer") || (temp == "EmptyStorageMinecartKillTimer") || (temp == "EmptyPoweredMinecartKillTimer") || (temp == "MinecartTrackAdjuster")) {
